...
export const FR_LABELS = {
  ...
  Vegetarian:'Végétarien', Breakfast:'Petit-déjeuner',
  French:'France', Italian:'Italie', Mexican:'Mexique', Chinese:'Chine', Indian:'Inde',
  Japanese:'Japon', Spanish:'Espagne', Thai:'Thaïlande', Greek:'Grèce', American:'États-Unis',
  Moroccan:'Maroc', Turkish:'Turquie',
};
